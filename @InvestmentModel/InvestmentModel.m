...
function compute_derivatives(o)
...
function [ll, status] = evaluate_loglikelihood_for_parameters(o, params, data, innov_for_sim)
    o.phi         = params(1);
    o.rho_z       = params(2);
    o.sigma_z     = params(3);
    o.rho_x_z     = params(4);
    o.sigma_x_z   = params(5);
    o.rho_x_b     = params(6);
    o.sigma_x_b   = params(7);
    o.rho_x_i     = params(8);
    o.sigma_x_i   = params(9);
    
    o.solve();
    
    status = sum(o.gensys_status);
    ll = o.evaluate_loglikelihood(data, innov_for_sim);
end
